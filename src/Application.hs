...
makeFoundation appSettings = do
    ...
    let newLoggerSet = case (appLoggerFilepath appSettings) of
                         Nothing -> newStdoutLoggerSet
                         Just fp -> flip newFileLoggerSet fp
    appLogger <- newLoggerSet defaultBufSize >>= makeYesodLogger
    appStatic <-
